...
![View Customise](https://github.com/PaulaSawczuk/GroupProject-UGT-FEAS/blob/main/kegg_pathway/src/assets/View_Customise.png)  *Fig.5b. shows customisation page.*  
...
- Upon user satisfaction with the selection, click "Search" (**N**) to add these pathways to the end of the pathway list in the side bar.
